    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMINISTRATOR', 'Administrator'), ('OPERATOR', 'Operator')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cabinet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='containers', to='api.cabinet', verbose_name='Шафа')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type', models.CharField(choices=[('WRITE_OFF', 'Списання'), ('REPLENISH', 'Поповнення'), ('INITIAL', 'Створення')], max_length=50, verbose_name='Тип транзакції')),
                ...
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.container', verbose_name='Ємність')),
